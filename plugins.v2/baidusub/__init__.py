...
from plugins.baidusub.ffmpeg import Ffmpeg
from plugins.baidusub.translate.baidu_translate import BaiduTranslate
...
class BaiduSub(_PluginBase):
    # 插件名称
    plugin_name = "字幕生成与翻译"
    # 插件描述
    plugin_desc = "使用whisper自动生成视频字幕，使用百度翻译将字幕翻译成中文。"
    # 插件图标
    plugin_icon = "Baidu_C.png"
    # 主题色
    plugin_color = "#2C4F7E"
    # 插件版本
